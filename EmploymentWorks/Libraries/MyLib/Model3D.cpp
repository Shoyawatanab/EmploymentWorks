...
void mylib::Model3D::Initialize
(
	CommonResources* resouce, const wchar_t* szFileName, DirectX::SimpleMath::Vector3 Pos, float Scale
)
{
...
void mylib::Model3D::Render(DirectX::CXMMATRIX view, DirectX::CXMMATRIX projection)
{
