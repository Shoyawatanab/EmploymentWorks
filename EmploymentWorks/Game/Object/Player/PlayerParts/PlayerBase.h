#pragma once
#ifndef PlayerBase_DEFINED
#define PlayerBase_DEFINED
...
public:
	// コンストラクタ
	PlayerBase(CommonResources* resources, IComponent* parent, DirectX::SimpleMath::Vector3 initialScale, const DirectX::SimpleMath::Vector3& positonFromParent, const DirectX::SimpleMath::Quaternion& initialAngle);
	// デストラクタ
	virtual ~PlayerBase();
	// 初期化する
...
public:
	...
	//アニメーションの実行
	Animation::AnimationState AnimationUdate(const float& elapsdTime);
