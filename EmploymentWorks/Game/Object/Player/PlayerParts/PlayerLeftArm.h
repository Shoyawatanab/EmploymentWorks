#pragma once
#ifndef PlayerLeftArm_DEFINED
#define PlayerLeftArm_DEFINED
#include "Interface/IComponent.h"
#include "Game/Object/Player/PlayerParts/PlayerBase.h"


// 「砲塔」クラスを定義する
class PlayerLeftArm : public PlayerBase
{
public:
	//現在の大きさの取得
...
public:
	// コンストラクタ
	PlayerLeftArm(CommonResources* resources, IComponent* parent,const  DirectX::SimpleMath::Vector3 scale, const DirectX::SimpleMath::Vector3& positonFromParent, const DirectX::SimpleMath::Quaternion& initialAngleRL);
	// デストラクタ
...
private:
	...
	// 砲塔部品配列
	std::vector<std::unique_ptr<IComponent>> m_PlayerLeftArmParts;
	//	ワールド行列
	DirectX::SimpleMath::Matrix m_worldMatrix;
	// 砲塔中心点
	DirectX::SimpleMath::Vector3 m_PlayerLeftArmCenter;
};

#endif		// PlayerLeftArm_DEFINED
