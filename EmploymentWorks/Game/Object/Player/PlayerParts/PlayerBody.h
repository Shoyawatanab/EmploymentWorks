#pragma once
#ifndef PlayerBody_DEFINED
#define PlayerBody_DEFINED
...
public:
	// コンストラクタ
	PlayerBody(CommonResources* resources, IComponent* parent,const  DirectX::SimpleMath::Vector3 scale, const DirectX::SimpleMath::Vector3& positonFromParent, const DirectX::SimpleMath::Quaternion& initialAngleRL);
	// デストラクタ
	~PlayerBody() override;
	// 初期化する
...
private:
	...
	// 砲塔部品配列
	std::vector<std::unique_ptr<IComponent>> m_PlayerBodyParts;
	//	ワールド行列
	DirectX::SimpleMath::Matrix m_worldMatrix;
	// 砲塔中心点
	DirectX::SimpleMath::Vector3 m_PlayerBodyCenter;
};

#endif		// PlayerBody_DEFINED
