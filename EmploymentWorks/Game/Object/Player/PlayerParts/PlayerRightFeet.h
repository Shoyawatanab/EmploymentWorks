#pragma once
#ifndef PlayerRightFeet_DEFINED
#define PlayerRightFeet_DEFINED
#include "Interface/IComponent.h"
#include "Game/Object/Player/PlayerParts/PlayerBase.h"


// 「砲塔」クラスを定義する
class PlayerRightFeet : public PlayerBase
{
public:
	//現在の大きさの取得
...
public:
	// コンストラクタ
	PlayerRightFeet(CommonResources* resources, IComponent* parent,const  DirectX::SimpleMath::Vector3 scale, const DirectX::SimpleMath::Vector3& positonFromParent, const DirectX::SimpleMath::Quaternion& initialAngleRL);
	// デストラクタ
...
private:
	...
	// 砲塔部品配列
	std::vector<std::unique_ptr<IComponent>> m_PlayerRightFeetParts;
	//	ワールド行列
	DirectX::SimpleMath::Matrix m_worldMatrix;
	// 砲塔中心点
	DirectX::SimpleMath::Vector3 m_PlayerRightFeetCenter;
};

#endif		// PlayerRightFeet_DEFINED
