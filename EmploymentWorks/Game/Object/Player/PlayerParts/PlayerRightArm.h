#pragma once
#ifndef PlayerRightArm_DEFINED
#define PlayerRightArm_DEFINED
#include "Interface/IComponent.h"
#include "Game/Object/Player/PlayerParts/PlayerBase.h"


// 「砲塔」クラスを定義する
class PlayerRightArm : public PlayerBase
{
public:
	//現在の大きさの取得
...
public:
	// コンストラクタ
	PlayerRightArm(CommonResources* resources, IComponent* parent,const  DirectX::SimpleMath::Vector3 scale, const DirectX::SimpleMath::Vector3& positonFromParent, const DirectX::SimpleMath::Quaternion& initialAngleRL);
	// デストラクタ
...
private:
	...
	// 砲塔部品配列
	std::vector<std::unique_ptr<IComponent>> m_PlayerRightArmParts;
	//	ワールド行列
	DirectX::SimpleMath::Matrix m_worldMatrix;
	// 砲塔中心点
	DirectX::SimpleMath::Vector3 m_PlayerRightArmCenter;
};

#endif		// PlayerRightArm_DEFINED
