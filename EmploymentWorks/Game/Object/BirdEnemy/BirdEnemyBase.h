#pragma once
#ifndef BirdEnemyBase_DEFINED
#define BirdEnemyBase_DEFINED
...
class BirdEnemyBase : public IComponent
{
public:
...
public:
	// コンストラクタ
	BirdEnemyBase(CommonResources* resources,IComponent* parent,DirectX::SimpleMath::Vector3 initialScale, const DirectX::SimpleMath::Vector3& positonFromParent, const DirectX::SimpleMath::Quaternion& initialAngle);
	// デストラクタ
	virtual ~BirdEnemyBase();
	// 初期化する
