#pragma once
#ifndef BossEnemyLeftThigh_DEFINED
#define BossEnemyLeftThigh_DEFINED
#include "Interface/IComponent.h"
#include  "Game/Object/Enemy/BossEnemy/BossEnemyBase.h"


// 「砲塔」クラスを定義する
class BossEnemyLeftThigh : public BossEnemyBase
{
public:
	//現在の大きさの取得
...
private:
	...
	// 砲塔部品配列
	std::vector<std::unique_ptr<IComponent>> m_BossEnemyLeftThighParts;
	//	ワールド行列
	DirectX::SimpleMath::Matrix m_worldMatrix;
	// 砲塔中心点
	DirectX::SimpleMath::Vector3 m_BossEnemyLeftThighCenter;
};

#endif		// BossEnemyLeftThigh_DEFINED
