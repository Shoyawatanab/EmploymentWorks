#pragma once
#ifndef BossEnemyHead_DEFINED
#define BossEnemyHead_DEFINED
#include "Interface/IComponent.h"
#include  "Game/Object/Enemy/BossEnemy/BossEnemyBase.h"


// 「砲塔」クラスを定義する
class BossEnemyHead : public BossEnemyBase
{
public:
	//現在の大きさの取得
...
public:
	// コンストラクタ
	BossEnemyHead(CommonResources* resources, IComponent* parent,const DirectX::SimpleMath::Vector3 scale, const DirectX::SimpleMath::Vector3& positonFromParent, const DirectX::SimpleMath::Quaternion& initialAngleRL);
	// デストラクタ
...
private:
	...
	// 砲塔部品配列
	std::vector<std::unique_ptr<IComponent>> m_BossEnemyHeadParts;
	//	ワールド行列
	DirectX::SimpleMath::Matrix m_worldMatrix;
	// 砲塔中心点
	DirectX::SimpleMath::Vector3 m_BossEnemyHeadCenter;
};

#endif		// BossEnemyHead_DEFINED
