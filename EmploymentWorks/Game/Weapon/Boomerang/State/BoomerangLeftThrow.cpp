...
/// コンストラクタ
/// </summary>
BoomerangLeftThrow::BoomerangLeftThrow()
	:
	m_commonResources{}
...
void BoomerangLeftThrow::AddPointer(Boomerang* boomerang, Player* player, TargetMarker* targetMarker,WataLib::TPS_Camera* tpsCamera)
{
...
/// スプライン曲線の基準点の作成
/// </summary>
void BoomerangLeftThrow::CreateSplineCurvePositon()
{
...
void BoomerangLeftThrow::SplineCurve(const float& elapsedTime)
{
	//座標の距離を求める
...
/// </summary>
/// <param name="elapsedTime">経過時間</param>
void BoomerangLeftThrow::ChaseToPlayer(const float& elapsedTime)
{
	//ブーメランの座標を取得
...
/// </summary>
/// <param name="elapsedTime">経過時間</param>
void BoomerangLeftThrow::Rotation(const float& elapsedTime)
{
...
void BoomerangLeftThrow::ChangeRotationDatas(DirectX::SimpleMath::Quaternion firstVec, DirectX::SimpleMath::Quaternion secondVec)
{
...
void BoomerangLeftThrow::Initialize(CommonResources* resources)
{
...
/// </summary>
/// <param name="elapsedTime">経過時間</param>
void BoomerangLeftThrow::Update(const float& elapsedTime)
{
	//回転
