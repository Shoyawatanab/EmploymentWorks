...
/// コンポーネント
/// </summary>
CollisionManager2::CollisionManager2()
	:
	m_colliderList{}
{
}
...
void CollisionManager2::Update(const float& deltaTime)
{
...
void CollisionManager2::AddCollider(ColliderComponent* collider)
{
	//すでに追加されているか
...
/// </summary>
/// <param name="collider"></param>
void CollisionManager2::RemoveCollider(ColliderComponent* collider)
{
	//すでに追加されているか
	auto it = std::find(m_colliderList.begin(), m_colliderList.end(), collider);
...
void CollisionManager2::Collision_Collision(ColliderComponent* collider1, ColliderComponent* collider2)
{
}

void CollisionManager2::Fixed_Fixed(ColliderComponent* collider1, ColliderComponent* collider2)
{
}

void CollisionManager2::Trigger_Trigger(ColliderComponent* collider1, ColliderComponent* collider2)
{
}
...
void CollisionManager2::Fixed_Collision(ColliderComponent* collider1, ColliderComponent* collider2)
{
...
void CollisionManager2::Fixed_Trigger(ColliderComponent* collider1, ColliderComponent* collider2)
{
}

void CollisionManager2::Collision_Trigger(ColliderComponent* collider1, ColliderComponent* collider2)
{
}
...
void CollisionManager2::SendNotification(ColliderComponent* collider1, ColliderComponent* collider2,bool isHit)
{
